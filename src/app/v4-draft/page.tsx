...
/* Draft: the form is switched off. Flip to false (and wire useContactForm back in) to go live. */
const DEMO = true
...
function ContactForm() {
  return (
    <>
      ...
      {DEMO && <p className="text-xs text-ink/50">Draft: the form is switched off on this preview.</p>}
      </form>
    </>
  )
}
    ...
    <>
      ...
      <section className="bg-paper px-6 py-24 text-ink md:py-32">
        <div className="mx-auto flex max-w-2xl flex-col items-center gap-8 text-center">
          ...
          <p className="max-w-md text-lg text-ink/70">
            ...
            <Link href="/v4-draft#contact" className="font-semibold text-accent hover:opacity-80">
              yes
            </Link>
            .
          </p>
      ...
      <section className="bg-accent px-6 py-24 text-paper md:py-32">
        <div className="mx-auto flex max-w-2xl flex-col items-center gap-6 text-center">
          ...
          <p className="text-lg text-paper/85">
            Nothing to learn.{" "}
            <Link href="/v4-draft/learn" className="text-paper underline underline-offset-4 hover:opacity-80">
